            ...
            <div className={s.footer__inner}>
                <div>
                    ...
                    <div className={s.footer__socialBlock}>
                        <a className={s.footer__socialLink} href="#s"><img src={twitter} alt=""/></a>
                        <a className={s.footer__socialLink} href="#s"><img src={insta} alt=""/></a>
                        <a className={s.footer__socialLink} href="#s"><img src={fb} alt=""/></a>
                    </div>
                </div>
